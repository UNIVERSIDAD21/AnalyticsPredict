#!/usr/bin/env python3
"""Aplica vistas restantes de bloque 06 y corre validaciones mínimas completas."""
...
def run() -> Path:
    ...
    validation_file = SQL_DIR / "11_validaciones_minimas_bloque_06_completo.sql"
    ...
    out_path = REPORT_DIR / "cierre_bloque_06_validaciones_20260307T0230Z.json"
