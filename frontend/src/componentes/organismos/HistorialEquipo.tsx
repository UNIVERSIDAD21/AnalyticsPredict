/**
 * HistorialEquipo.tsx — Panel reutilizable de historial de partidos por equipo
 */
...
interface PropsHistorialEquipo {
  equipoId: string;
  onCerrar?: () => void;
  textoCerrar?: string;
}
...
export function HistorialEquipo({
  equipoId,
  onCerrar,
  textoCerrar = 'Cerrar historial',
}: PropsHistorialEquipo) {
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div className="tarjeta">
          <p className="text-xs text-texto-terciario uppercase tracking-wider">Record total</p>
