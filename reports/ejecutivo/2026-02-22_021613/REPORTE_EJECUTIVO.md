...
- ingestion_state_baloncesto: stale=True sev=critica horas=109.32
- ingestion_state_futbol: stale=True sev=media horas=None
- predicciones_registradas: stale=True sev=critica horas=216.15
- predicciones_futbol: stale=False sev=baja horas=5.84
