...
- Se inicia Fase C en frontend: gating por acción reutilizable con copy centralizado (`useGateNavigation` + `obtenerGateCopy`) aplicado en encabezado, centro analítico y dashboard de usuario.
